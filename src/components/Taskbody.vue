<template>
  <div  class="tableouter">
    ...
    <div class="table-container">
      <div  class="divider">
         <h3 :style="{textTransform:'uppercase',fontSize:'1em',color:'#191970'}">Pending Task</h3>
    ...
    <h3 :style="{textTransform:'uppercase',fontSize:'1em',color:'#191970'}">Completed Task</h3>
    <table :style="{ border: '1px solid black', width: '75%',margin:'1em'}">
      <thead >
        <tr>
          <th>Task</th>
